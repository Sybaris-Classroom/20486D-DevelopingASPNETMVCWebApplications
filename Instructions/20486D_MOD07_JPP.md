...
11. In Solution Explorer, right-click **Repositories**, point to **Add**, and then click **Class**.
...
1. In Solution Explorer, expand **Controllers**, and then click **CupcakeController.cs**.
