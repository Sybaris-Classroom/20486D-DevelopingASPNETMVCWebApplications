...
2. Navigate to **\Allfiles\Mod10\Labfiles\01_ShirtStore_begin**, and then open the **ShirtStore.sln**.
...
1. On the **TEST** menu, point to **Run**, and then click **All Tests**.
...
1. In Solution Explorer, under **ShirtStoreWebsite**, expand **Models**, and then click **Shirt.cs**. 
...
1. In Solution Explorer, right-click **ShirtStoreWebsite**, point to **Add**, and then click **New Folder**.

2. In the **NewFolder** box, type **Services**, and then press Enter.

3. In Solution Explorer, right-click **Services**, point to **Add**, and then click **New Item**.
...
3. In Solution Explorer, right-click **FakeRepositories**, point to **Add**, and then click **Class**.
...
1. In Solution Explorer, expand **Controllers**, and then click **ShirtController.cs**.
...
5. In Solution Explorer, right-click **Controllers**, point to **Add**, and then click **Class**.
...
1. In Solution Explorer, under **ShirtStoreWebsite**, under **Controllers**, click **ShirtController.cs**.
...
1. In Solution Explorer, right-click **Services**, point to **Add**, and then click **Class**.
...
1. In Solution Explorer, in the **Startup.cs** code window, locate the following code:
```cs
...
1. In Solution Explorer, under **Controllers**, click **ShirtController.cs**.
...
1. On the toolbar, click the arrow next to the **Start Debugging** button, and then click **Development**.​
...
1. On the toolbar, click the arrow next to the **Start Debugging** button, and then click **Production**.​
...
1. In Solution Explorer, right-click **ShirtStoreWebsite**, point to **Add**, and then click **New Item**.
...
7. In Solution Explorer, right-click **ShirtStoreWebsite**, point to **Add**, and then click **New Item**.
...
13. In Solution Explorer, click **Program.cs**. 
...
3. In Solution Explorer, under **ShirtStoreWebsite.Tests**,  click **ShirtControllerTest.cs**.
...
3. On the **Output** tab, in the **Show output from** list, select **ASP.NET Core Web Server**, and then click the **Clear All** button.
...
9. On the **Output** tab, press **ctrl + F**, and then locate the following text:
```
    A Yellow shirt of size M with a price of $12.00 was added successfully.
```
10.  On the **Output** tab, click **Clear All**.

11. In Microsoft Edge, on the **Shirts in stock** table, click the top **Delete** link.

12. In the **Output** tab, press **ctrl + F**, and then locate the following text:
```
...
5. In File Explorer, navigate to **\Allfiles\Mod10\Labfiles\01_ShirtStore_begin\ShirtStoreWebsite**, and then double-click **shirt_store_logs-XXXXXXXX.txt**.
...
14. In File Explorer, navigate to **\Allfiles\Mod10\Labfiles\01_ShirtStore_begin\ShirtStoreWebsite**, and then double-click **shirt_store_logs-XXXXXXXX.txt**.
