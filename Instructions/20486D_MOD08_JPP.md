...
2. In Solution Explorer, right-click **Views**, point to **Add**, and then click **New Folder**.

3. In the **NewFolder** box, type **Shared**, and then press Enter.

4. In Solution Explorer, under **Views**, right-click **Shared**, point to **Add**, and then click **New Item**.
...
1. In Solution Explorer, expand **Controllers**, and then click **ZooController.cs**.
...
1. In Solution Explorer, right-click **Views**, point to **Add**, and then click **New Item**.
...
4. In Solution Explorer, under **Views**, expand **Zoo**, and then click **Index.cshtml**.
...
1. In Solution Explorer, under **Views**, right-click **Zoo**, point to **Add**, and then click **Existing Item**.
...
1. In Solution Explorer, under **Views**, under **Shared**, click **_Layout.cshtml**.
...
1. In Solution Explorer, right-click **wwwroot**, point to **Add**, and then click **New Folder**.

2. In the **NewFolder** box, type **css**, and then press Enter.

3. In Solution Explorer, under **wwwroot**, right-click **css**, point to **Add**, and then click **Existing Item**.
...
5. In Solution Explorer, under **wwwroot**, under **css**, click **zoo-style.css**.

    >**Note**: Examine the content of the file.

6. In Solution Explorer, click **Startup.cs**.
...
1. In Solution Explorer, under **wwwroot**, under **css**, click **zoo-style.css**.
...
3. In Solution Explorer, under **wwwroot**, right-click **js**, point to **Add**, and then click **New Item**.
...
1. In Solution Explorer, under **Views**, under **Zoo**, click **BuyTickets.cshtml**.
...
1. In Solution Explorer, under **wwwroot**, under **js**, click **form-functions.js**.
...
1. In Solution Explorer, right-click **ZooSite**, point to **Add**, and then click **New Item**.
...
6. On the **FILE** menu, click **Save package.json**.
...
8. In Solution Explorer, in **Explorer Toolbar Options** click **Show All Files**.
...
9. In Solution Explorer, right-click **ZooSite**, point to **Add**, and then click **New Folder**.
...
23. In Solution Explorer, under **Views**, under **Shared**, click **_Layout.cshtml**.
...
6. In Solution Explorer, under **wwwroot**, right-click **js**, point to **Add**, and then click **New Item**.
...
10. In Solution Explorer, under **wwwroot**, right-click **js**, point to **Add**, and then click **New Item**.
...
```
14. In Solution Explorer, under **Views**, under **Shared**, click **_Layout.cshtml**.
...
1. In Solution Explorer, click **package.json**.
...
```
4. On the **FILE** menu, click **Save package.json**.
...
6. In Solution Explorer, under **Views**, under **Zoo**, click **BuyTickets.cshtml**.
