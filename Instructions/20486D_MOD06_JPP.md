...
2. In Solution Explorer, expand **Models**, and then click **Butterfly.cs**.
...
6. In Solution Explorer, right-click **Models**, point to **Add**, and then click **Class**.
...
1. In Solution Explorer, expand **Views**, and then expand **Butterfly**.

2. In Solution Explorer, under **Views**, under **Butterfly**, click **Index.cshtml**.
...
1. In Solution Explorer, expand **Controllers**, and then click **ButterflyController.cs**.
...
1. In Solution Explorer, under **Controllers**, click **ButterflyController.cs**.
...
1. In Solution Explorer, under **Models**, click **Butterfly.cs**.
...
1. In Solution Explorer, under **Views**, under **Butterfly**, click **Index.cshtml**.
...
1. In Solution Explorer, under **Views**, under **Butterfly**, click **Create.cshtml**.
...
8. On the **Add Butterflies to The Shop** page, in the **Butterflies Picture** box, select _&lt;A butterfly picture of your choice from \Allfiles\Mod06\Labfiles\Images&gt;_, and then click **Submit**.
...
9. On the **Add Butterflies to The Shop** page, in the **Butterflies Picture** box, select _&lt;A butterfly picture of your choice from \Allfiles\Mod06\Labfiles\Images&gt;,_ and then click **Submit**.
...
3. In Solution Explorer, right-click **Validators**, point to **Add**, and then click **Class**.
...
12. In Solution Explorer, expand **Models**, and then click **Butterfly.cs**.
...
10. On the **Add Butterflies to The Shop** page, in the **Butterflies Picture** box, select _&lt;A butterfly picture of your choice from \Allfiles\Mod06\Labfiles\Images&gt;,_ and then click **Submit**.
