...
13. In Solution Explorer, click **package.json**.
...
1. In Solution Explorer, expand **Views**, expand **Shared**, and then click **_Layout.cshtml**.
...
1. In Solution Explorer, right-click **ElectricStore**, point to **Add**, and then click **New Folder**.

2. In the **NewFolder** box, type **ViewComponents**, and then press Enter.

3. In Solution Explorer, right-click **ViewComponents**, point to **Add**, and then click **Class**.
...
10. In Solution Explorer, under **Views**, right-click **Shared**, point to **Add**, and then click **New Folder**.

11. In the **NewFolder** box, type **Components**, and then press Enter.

12. In Solution Explorer, right-click **Components**, point to **Add**, and then click **New Folder**.

13. In the **NewFolder** box, type **NavbarMenu**, and then press Enter.

14. In Solution Explorer, right-click **NavbarMenu**, point to **Add**, and then click **New Item**.
...
10. In Solution Explorer, under **Views**, expand **Products**, and then click **Index.cshtml**.
...
1. In Solution Explorer, under **Controllers**, click **ProductsController.cs**.
...
4. In Solution Explorer, under **Controllers**, click **ShoppingCartController.cs**.
...
3. In Solution Explorer, right-click **Hubs**, point to **Add**, and then click **Class**.
...
8. In Solution Explorer, click **package.json**.
...
1. In Solution Explorer, under **Controllers**, click **ShoppingCartController.cs**.
...
11. In Solution Explorer, under **Views**, expand **ShoppingCart**, and then click **Index.cshtml**.
...
3. In Solution Explorer, under **wwwroot**, right-click **js**, point to **Add**, and then click **Existing Item**.

4. In the **Add Existing Item - ElectricStore** dialog box, go to **\Allfiles\Mod12\Labfiles\ElectricStoreJS**, select **chat-hub.js** file, and then click **Add**.

5. In Solution Explorer, under **Views**, under **ShoppingCart**, click **Chat.cshtml**.
