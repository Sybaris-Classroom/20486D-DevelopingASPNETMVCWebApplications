...
2. Navigate to **\Allfiles\Mod04\LabFiles\01_WorldJourney_begin**, and then open the **WorldJourney.sln**.
...
4. In Solution Explorer, right-click the **Controllers** folder, point to **Add**, and then select **Controller**.
...
7. In Solution Explorer, right-click the **Controllers** folder, point to **Add**, and then select **Controller**.
...
1. In Solution Explorer, expand **Controllers**, and then click **HomeController.cs**.
...
1. In Solution Explorer, right-click the **Controllers** folder, point to **Add**, and then select **Controller**.
...
3. In Solution Explorer, right-click **Filters**, point to **Add**, and then select **Class**.
...
5. In Solution Explorer, expand **Controllers**, and then click **CityController.cs**.
...
8. Navigate to **\Allfiles\Mod04\Labfiles\01_WorldJourney_begin\WorldJourney\LogFile** and open **Text file**. 
