...
2. In Solution Explorer, expand **Services**, and then click **CityProvider.cs**.
...
5. In Solution Explorer, expand **Models**, and then click **City.cs**.
...
8. In Solution Explorer, under **Models**, click **CityPopulation.cs**.
...
11. In Solution Explorer, expand **Controllers**, and then click **CityController.cs**.
...
1. In Solution Explorer, under **Controllers**, click **CityController.cs**.
...
13. In Solution Explorer, under **Controllers**, click **CityController.cs**.
...
5. In Solution Explorer, expand **Views**, expand **City**, and then click **ShowDataForCity.cshtml**.
...
8. In Solution Explorer, under **Views**, under **City**, click **ShowCities.cshtml**.
...
1. In Solution Explorer, right-click **Views**, point to **Add**, and then click **New Folder**.
...
1. In Solution Explorer, under **Views**, under **City**, click **ShowDataForCity.cshtml**.
...
1. In Solution Explorer, right-click **CitiesWebsite**, point to **Add**, and then click **New Folder**.
...
1. In Solution Explorer, under **Views**, right-click **Shared**, point to **Add**, and then click **New Folder**.

2. In the **NewFolder** box, type **Components**, and then press Enter.

3. In Solution Explorer, right-click **Components**, point to **Add**, and then click **New Folder**.

4. In the **NewFolder** box, type **City**, and then press Enter.

5. In Solution Explorer, right-click the **City** folder you just created, point to **Add**, and then click **View**.
...
1. In Solution Explorer, under **Views**, under **City**, click **ShowCities.cshtml**.
