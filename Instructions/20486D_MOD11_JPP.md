...
2. Navigate to **\Allfiles\Mod11\Labfiles\01_Library_begin**, and then open the **Library.sln**.
...
9. In Solution Explorer, expand **Models**, and then click **User.cs**.
...
14. In Solution Explorer, expand **Data**, and then click **LibraryContext.cs**.
...
1. In Solution Explorer, expand **Views**, expand **Library**, and then click **LendingBook.cshtml**.
...
```
4. In Solution Explorer, under **Views**, expand **Shared**, and then click **_Layout.cshtml**.
...
1. In Solution Explorer, expand **Controllers**, and then click **LibraryController.cs**.
...
1. In Solution Explorer, expand **ViewModels**, and then click **RegisterViewModel.cs**.
...
4. In Solution Explorer, under **Controllers**, click **AccountController.cs**.
...
9. In Solution Explorer, under **Views**, expand **Account**, and then click **Register.cshtml**.
...
12. In Solution Explorer, under **Controllers**, click **LibrarianController.cs**.
...
6. In Solution Explorer, under **Controllers**, click **AccountController.cs**.
...
```
11. In Solution Explorer, under **Controllers**, click **LibrarianController.cs**.
...
3. In Solution Explorer, in the **CrossSiteRequestForgeryAttack** project, right-click the **Controllers** folder, point to **Add**, and then click **Controller**.
...
1. In Solution Explorer, under **Controllers**, click **AccountController.cs**.
...
``` 
4. In Solution Explorer, under **Controllers**, click **LibrarianController.cs**.
...
6. Place the cursor before the located code, press the up arrow key, and then type the following code:
  ```cs
       [ValidateAntiForgeryToken]
``` 
7. In Solution Explorer, under **Controllers**, click **LibraryController.cs**.
