...
9. Navigate to **\Allfiles\Mod13\Labfiles\01_Restaurant_begin**, and then open the **Restaurant.sln**.
...
2. In Solution Explorer, under **Server**, right-click **Controllers**, point to **Add**, and then click **Controller**.
...
1. In Solution Explorer, under **Server**, right-click **Controllers**, point to **Add**, and then click **Controller**.
...
1. In Solution Explorer, under **Server**, expand **Controllers**, and then click **ReservationController**.
...
1. In Solution Explorer, under **Client**, click **Startup.cs**.
...
4. In Solution Explorer, under **Client**, right-click **Controllers**, point to **Add**, and then click **Controller**.
...
```
13. In Solution Explorer, under **Client**, expand **Views**, expand **RestaurantBranches**, and then click **Index.cshtml**.

     >**Note**: Examine the file content.

#### Task 2: Run the application

1. In Solution Explorer, under **Server**, under **Properties**, click **launchSettings.json**.
...
1. In Solution Explorer, under **Client**, right-click **Controllers**, point to **Add**, and then click **Controller**.
...
10. In Solution Explorer, under **Client**, under **Views**, expand **Reservation**, and then click **Create.cshtml**.

    >**Note**: Examine the file content.


11. In Solution Explorer, under **Controllers** click **ReservationController.cs**.
...
3. In Solution Explorer, under **Client**, under **Views**, under **Reservation**, click **ThankYouAsync.cshtml**.
...
1. In Solution Explorer, under **Client**, expand **wwwroot**, right-click **js**, point to **Add**, and then click **New Item**.
...
8. In Solution Explorer, under **Client**, under **Views**, expand **WantedAd**, and then click **Index.cshtml**.
...
10. In Solution Explorer, under **Client**, under **Views**, expand **JobApplication**, and then click **Create.cshtml**.

     >**Note**: Examine the file content.

11. In Solution Explorer, under **Client**, under **Controllers** click **JobApplicationController.cs**.
...
16. In Solution Explorer, under **Client**, under **Views**, expand **JobApplication**, and then click **ThankYou.cshtml**.

     >**Note**: Examine the file content.

#### Task 4: Calling a Web API Post method by using jQuery

1. In Solution Explorer, under **Client**, under **wwwroot**, right-click **js**, point to **Add**, and then click **New Item**.
...
6. In Solution Explorer, under **Client**, under **Views**, under **JobApplication**, click **Create.cshtml**.
