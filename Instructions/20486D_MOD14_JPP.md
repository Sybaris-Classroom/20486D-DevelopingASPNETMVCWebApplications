...
1. Open Solution Explorer, right-click **Underwater**, and then click **Edit Underwater.csproj**.
...
5. In Solution Explorer, right-click **Underwater**, and then click **Publish**.
...
1. In the **Publish** window, click **Publish**.
...
1. In Solution Explorer, expand **Models**, and then click **Fish.cs**.
...
4. In Solution Explorer, expand **Views**, expand **Aquarium**, and then click **Details.cshtml**.
...
7. In Solution Explorer, under **Views**, under **Aquarium**, click **Edit.cshtml**.
...
```
10. In Solution Explorer, under **Views**, under **Aquarium**, click **Create.cshtml**.
...
```
13. In Solution Explorer, under **Views**, under **Aquarium**, click **Delete.cshtml**.
...
```
16. In Solution Explorer, expand **Controllers**, and then click **AquariumController.cs**.
...
19. On the **TOOLS** menu, point to **NuGet Package Manager**, and then click **Package Manager Console**.
...
22. Open Solution Explorer, right-click **Underwater**, and then click **Publish**.
...
1. In Solution Explorer, right-click **Underwater**,  point to **Add**, and then click **Connected Service**.
...
6. In Solution Explorer, click **appsettings.json**.
...
1. In Solution Explorer, expand **Models**, and click **Fish.cs**.
...
```
10. In Solution Explorer, under **Views**, under **Aquarium**, click **index.cshtml**.
...
16. In Solution Explorer, right-click **Underwater**, and then click **Manage NuGet Packages**.
...
23. In Solution Explorer, under **Repositories**, click **UnderwaterRepository.cs**.
...
36. On the **FILE** menu, click **Save All**.

37. On the **TOOLS** menu, point to **NuGet Package Manager**, and then click **Package Manager Console**.
...
1. Open Solution Explorer, right-click **Underwater**, and then click **Publish**.
