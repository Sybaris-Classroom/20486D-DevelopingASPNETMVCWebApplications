...
9. In the **New ASP.NET Core Web Application - ActorsRazorPages** dialog box, in the result pane, click **Web Application**, and then click **OK**.

10. In the **ActorsRazorPages –  Microsoft Visual Studio** window, on the **DEBUG** menu, click **Start Without Debugging**.
...
12. In Microsoft Edge, in the navigation bar, click **Contact** to review its content.
...
10. In the **AnimalsMvc –  Microsoft Visual Studio** window, on the **DEBUG** menu, click **Start Without Debugging**.
