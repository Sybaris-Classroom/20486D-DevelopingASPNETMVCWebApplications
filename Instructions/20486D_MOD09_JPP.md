...
12. In Solution Explorer, click **package.json**.
...
1. In Solution Explorer, right-click **IceCreamCompany**, point to **Add**, and then click **New Item**.
...
2. In Solution Explorer, right-click **gulpfile.js**, and then click **Task Runner Explorer**.
...
4. In Solution Explorer, expand **Scripts**, and then click **payment-calc.js**.
...
6. In Solution Explorer, under **wwwroot**, under **scripts**, click **script.min.js**.
...
8. In Solution Explorer, under **Scripts**, click **payment-calc.js**.
...
11. On the **FILE** menu, click **Save payment-calc.js**.

12. In the **Microsoft Visual Studio** dialog box, click **Yes to All**.

13. In Solution Explorer, under **wwwroot**, under **scripts**, click **script.min.js**.
...
1. In Solution Explorer, right-click **IceCreamCompany**, point to **Add**, and then click **New Folder**.

2. In the **NewFolder** box, type **Styles**, and then press Enter.

3. In Solution Explorer, right-click **Styles**, point to **Add**, and then click **New Item**.
...
1. In Solution Explorer, click **gulpfile.js**.
...
6. In Solution Explorer, expand **Controllers**, and then click **IceCreamController.cs**.
